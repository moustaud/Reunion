...
<html>
    ...
    <body>
        ...
        <div id="show-voting" class="content scaffold-show" role="main">
            ...
            <f:display bean="voting" />
            <g:form resource="${this.voting}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.voting}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
