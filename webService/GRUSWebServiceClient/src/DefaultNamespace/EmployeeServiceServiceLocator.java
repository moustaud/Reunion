...
public class EmployeeServiceServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.EmployeeServiceService {
    ...
    private java.lang.String EmployeeService_address = "http://localhost:8080/GRUSWebService/services/EmployeeService";
    ...
    public DefaultNamespace.EmployeeService getEmployeeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.EmployeeServiceSoapBindingStub _stub = new DefaultNamespace.EmployeeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.EmployeeService.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.EmployeeServiceSoapBindingStub _stub = new DefaultNamespace.EmployeeServiceSoapBindingStub(new java.net.URL(EmployeeService_address), this);
                _stub.setPortName(getEmployeeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "EmployeeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "EmployeeService"));
        }
